...
{
public:
	Contact(std::vector<Object*> objects, glm::vec3 contactNormal, glm::vec3 contactPoint, float penetration, float restitution, float staticFriction, float dynamicFriction);
	Contact() = default;
	...
	float desiredRestitutionVelocity;
